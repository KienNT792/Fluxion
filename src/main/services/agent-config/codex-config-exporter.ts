...
export class CodexConfigExporter implements AgentConfigExporter {
  ...
  public readonly description = 'Export Fluxion project context to AGENTS.md and optional .codex/config.toml.';
  ...
  public async createPreview(
    ...
    if (context.contextStatus !== 'ready') {
      warnings.push('The Fluxion project context is not ready yet; exported instructions may be incomplete.');
    }
